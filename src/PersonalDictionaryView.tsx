...
import { ArrowLeft, Bookmark, Download, ExternalLink, Trash2 } from "lucide-react";
...
export default function PersonalDictionaryView({
  ...
  return (
    <section className="page-section narrow-page bounded-list-page personal-dictionary-page">
      <PageTitle onBack={onBack} onExport={onExport} />
...
function PageTitle({ onBack, onExport }: { onBack: () => void; onExport: () => void }) {
  return (
    <div className="page-heading">
      ...
      <div className="button-group">
        ...
        <button className="secondary-button small-button" type="button" onClick={onBack} title="返回词典" aria-label="返回词典">
          <ArrowLeft size={15} />
          返回
        </button>
      </div>
